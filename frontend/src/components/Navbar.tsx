    ...
    <header className="sticky top-0 z-40 bg-slate-900/90 backdrop-blur-md border-b border-slate-800">
        ...
        <div className="flex items-center justify-between h-16">
          ...
          <nav className="hidden md:flex items-center space-x-2">
            ...
            {!role && (
              <Link
                to="/login"
                className="flex items-center gap-2 px-4 py-2 rounded-xl bg-emerald-500 hover:bg-emerald-400 text-slate-950 font-bold text-xs shadow-md shadow-emerald-500/20 transition-all cursor-pointer"
              >
      ...
      <div className="md:hidden border-t border-slate-800 px-2 py-2 flex items-center justify-around overflow-x-auto">
        ...
        {!role && (
          <Link
            to="/login"
            className="flex items-center justify-center gap-2 w-full py-2 bg-emerald-500 text-slate-950 font-bold text-xs rounded-xl"
          >
